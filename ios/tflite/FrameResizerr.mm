...
//
//FrameResizerr::FrameResizerr(size_t targetWidth, size_t targetHeight, size_t channels, TFLTensorDataType dataType) {
...
////  size_t dataSize = TensorHelperss::getTFLTensorDataTypeSize(dataType);
...
//}
//
//const vImage_Buffer& FrameResizerr::resizeFrame(CVPixelBufferRef pixelBuffer) {
...
//       // size_t dataTypeSize = TensorHelperss::getTFLTensorDataTypeSize(_targetDataType);
