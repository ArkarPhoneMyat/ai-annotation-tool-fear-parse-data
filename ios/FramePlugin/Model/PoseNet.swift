...
//
//  /// Model files
//  private let posenetFile = FileInfo(name: "hp230504", ext: "tflite")
//
//  // MARK: - Initialization
//
...
//
//   // let transformed = convertYpCbCr(pixelBuffer: pixelBuffer, intoARGBBuffer: &srcBuffer)
//    // if !transformed { return nil }
//   // let src = createImage(from: pixelBuffer)
//   // if !src { return nil }
//
////    guard let buffer = getPixelBuffer(from: srcBuffer, width: Int(srcBuffer.width), height: Int(srcBuffer.height)) else {
////       NSLog("Failed to get pixelBuffer from argbBuffer")
////       return nil
////     }
...
//      let x  = CGFloat(coords[index].x)
//      let y = CGFloat(coords[index].y)
